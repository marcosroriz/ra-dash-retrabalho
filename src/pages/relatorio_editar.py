...
# Tela para editar um relatório de retrabalho
...
@callback(
    [
        ...
        Output("pag-editar-relatorio-input-select-modelo-veiculos", "value"),
        Output("pag-editar-relatorio-input-select-oficina", "value"),
        ...
        Output("pag-editar-relatorio-input-email-3", "value"),
        Output("pag-editar-relatorio-input-email-4", "value"),
        Output("pag-editar-relatorio-input-email-5", "value"),
        Output("pag-editar-relatorio-switch-enviar-wpp-regra", "checked"),
        Output("pag-editar-relatorio-input-wpp-1", "value"),
        Output("pag-editar-relatorio-input-wpp-2", "value"),
...
def cb_pag_editar_regra_receber_campos_via_url(href):
    ...
    if not parsed_url.path.startswith("/relatorio-editar"):
        raise dash.exceptions.PreventUpdate
    ...
    df_regra = crud_relatorio_service.get_regra_by_id(id_regra)
...
@callback(
    Output("pag-editar-relatorio-input-select-modelo-veiculos", "value", allow_duplicate=True),
    Input("pag-editar-relatorio-input-select-modelo-veiculos", "value"),
    prevent_initial_call=True,
)
...
@callback(
    Output("pag-editar-relatorio-input-select-oficina", "value", allow_duplicate=True),
    Input("pag-editar-relatorio-input-select-oficina", "value"),
    prevent_initial_call=True,
)
...
@callback(
    Output("pag-editar-relatorio-input-select-secao", "value", allow_duplicate=True),
    Input("pag-editar-relatorio-input-select-secao", "value"),
    prevent_initial_call=True,
)
...
@callback(
    ...
    [
        Input("pag-editar-relatorio-input-select-ordens-servico", "value"),
        Input("pag-editar-relatorio-input-select-secao", "value"),
    ],
    prevent_initial_call=True,
)
...
@callback(
    Output("pag-editar-relatorio-input-email-destino-container", "style"),
    Input("pag-editar-relatorio-switch-enviar-email", "checked"),
)
...
@callback(
    Output("pag-editar-relatorio-input-wpp-destino-container", "style"),
    Input("pag-editar-relatorio-switch-enviar-wpp-regra", "checked"),
)
...
@callback(
    Output("pag-editar-relatorio-input-email-1", "error"),
    Input("pag-editar-relatorio-input-email-1", "value"),
)
...
@callback(
    Output("pag-editar-relatorio-input-email-2", "error"),
    Input("pag-editar-relatorio-input-email-2", "value"),
)
...
@callback(
    Output("pag-editar-relatorio-input-email-3", "error"),
    Input("pag-editar-relatorio-input-email-3", "value"),
)
...
@callback(
    Output("pag-editar-relatorio-input-email-4", "error"),
    Input("pag-editar-relatorio-input-email-4", "value"),
)
...
@callback(
    Output("pag-editar-relatorio-input-email-5", "error"),
    Input("pag-editar-relatorio-input-email-5", "value"),
)
...
@callback(
    Output("pag-editar-relatorio-input-wpp-1", "error"),
    Input("pag-editar-relatorio-input-wpp-1", "value"),
)
...
@callback(
    Output("pag-editar-relatorio-input-wpp-2", "error"),
    Input("pag-editar-relatorio-input-wpp-2", "value"),
)
...
@callback(
    Output("pag-editar-relatorio-input-wpp-3", "error"),
    Input("pag-editar-relatorio-input-wpp-3", "value"),
)
...
@callback(
    Output("pag-editar-relatorio-input-wpp-4", "error"),
    Input("pag-editar-relatorio-input-wpp-4", "value"),
)
...
@callback(
    Output("pag-editar-relatorio-input-wpp-5", "error"),
    Input("pag-editar-relatorio-input-wpp-5", "value"),
)
...
@callback(
    Output("pag-editar-relatorio-modal-erro-salvar", "opened", allow_duplicate=True),
    Input("pag-editar-relatorio-btn-close-modal-erro-salvar", "n_clicks"),
    prevent_initial_call=True,
)
...
@callback(
    ...
    Input("pag-editar-relatorio-btn-close-modal-sucesso-salvar", "n_clicks"),
    prevent_initial_call=True,
)
...
@callback(
    ...
    [
        ...
        Input("pag-editar-relatorio-input-select-dias", "value"),
        Input("pag-editar-relatorio-input-select-modelo-veiculos", "value"),
        Input("pag-editar-relatorio-input-select-oficina", "value"),
        Input("pag-editar-relatorio-input-select-secao", "value"),
        Input("pag-editar-relatorio-input-select-ordens-servico", "value"),
        Input("pag-editar-relatorio-checklist-dia-semana", "value"),
        Input("pag-editar-relatorio-switch-enviar-email", "checked"),
        Input("pag-editar-relatorio-input-email-1", "value"),
        Input("pag-editar-relatorio-input-email-2", "value"),
        Input("pag-editar-relatorio-input-email-3", "value"),
        ...
        Input("pag-editar-relatorio-input-wpp-4", "value"),
        Input("pag-editar-relatorio-input-wpp-5", "value"),
        Input("pag-editar-relatorio-horario-envio-regra", "value"),
    ],
    prevent_initial_call=True,
)
def cb_atualizarr_regra_relatorio(
    ...
    if triggered_id != "pag-editar-relatorio-btn-salvar-regra":
        return [dash.no_update, dash.no_update]
...
layout = dbc.Container(
    [
        ...
        dmc.Modal(
            ...
            id="pag-editar-relatorio-modal-erro-salvar",
            centered=True,
            radius="lg",
            size="md",
            children=dmc.Stack(
                    ...
                    dmc.Group(
                        [
                            dmc.Button(
                                ...
                                color="red",
                                variant="outline",
                                id="pag-editar-relatorio-btn-close-modal-erro-salvar",
                            ),
                        ],
                    ),
                ],
        ...
        dmc.Modal(
            # title="Erro ao carregar os dados",
            id="pag-editar-relatorio-modal-sucesso-salvar",
            centered=True,
            radius="lg",
            size="lg",
            children=dmc.Stack(
                    ...
                    dmc.Group(
                        [
                            dmc.Button(
                                ...
                                color="green",
                                variant="outline",
                                id="pag-editar-relatorio-btn-close-modal-sucesso-salvar",
                            ),
                        ],
                        # justify="flex-end",
                    ),
                    ...
                    dbc.Card(
                        html.Div(
                            [
                                ...
                                dbc.Input(
                                    id="pag-editar-relatorio-input-nome",
                                    type="text",
                        ...
                        html.Div(
                            [
                                ...
                                dbc.InputGroup(
                                    [
                                        dbc.Input(
                                            id="pag-editar-relatorio-input-periodo-dias-monitoramento",
                                            type="number",
                                            placeholder="Dias",
                                            value=7,
                                            step=1,
                        ...
                        [
                            html.Div(
                                [
                                    ...
                                    dcc.Dropdown(
                                        id="pag-editar-relatorio-input-select-dias",
                                        options=[
                        ...
                        [
                            html.Div(
                                [
                                    ...
                                    dcc.Dropdown(
                                        id="pag-editar-relatorio-input-select-modelo-veiculos",
                                        options=[
                                            {
                                                "label": os["MODELO"],
                                                "value": os["MODELO"],
                        ...
                        [
                            html.Div(
                                [
                                    dbc.Label("Oficinas"),
                                    dcc.Dropdown(
                                        id="pag-editar-relatorio-input-select-oficina",
                                        options=[
                        ...
                        [
                            html.Div(
                                [
                                    ...
                                    dcc.Dropdown(
                                        id="pag-editar-relatorio-input-select-secao",
                                        options=[
                        ...
                        [
                            html.Div(
                                [
                                    ...
                                    dcc.Dropdown(
                                        id="pag-editar-relatorio-input-select-ordens-servico",
                            ...
                            html.Div(
                                [
                                    ...
                                    dbc.RadioItems(
                                        ...
                                        value=1,
                                        id="pag-editar-relatorio-checklist-dia-semana",
                                        inline=True,
                                    ),
                                ],
                                className="dash-bootstrap",
                        ...
                        [
                            html.Div(
                                [
                                    ...
                                    dmc.TimeInput(
                                        debounce=True, id="pag-editar-relatorio-horario-envio-regra", value="06:00"
                                    ),
                                ],
                                className="dash-bootstrap",
                            ),
                    ...
                    dbc.Card(
                        dbc.Row(
                            [
                                dbc.Col(
                                    dmc.Switch(
                                        id="pag-editar-relatorio-switch-enviar-email",
                                        label="Enviar email",
                                        checked=False,
                                        size="md",
                                    ),
                                ...
                                dbc.Col(
                                    dbc.Row(
                                        [
                                            ...
                                            dbc.Col(
                                                dmc.TextInput(
                                                    id="pag-editar-relatorio-input-email-1",
                                            ...
                                            dbc.Col(
                                                dmc.TextInput(
                                                    id="pag-editar-relatorio-input-email-2",
                                            ...
                                            dbc.Col(
                                                dmc.TextInput(
                                                    id="pag-editar-relatorio-input-email-3",
                                            ...
                                            dbc.Col(
                                                dmc.TextInput(
                                                    id="pag-editar-relatorio-input-email-4",
                                            ...
                                            dbc.Col(
                                                dmc.TextInput(
                                                    id="pag-editar-relatorio-input-email-5",
                                    ...
                                    id="pag-editar-relatorio-input-email-destino-container",
                                    md=12,
                                ),
                            ],
                            align="center",
                    ...
                    dbc.Card(
                        dbc.Row(
                            [
                                dbc.Col(
                                    dmc.Switch(
                                        id="pag-editar-relatorio-switch-enviar-wpp-regra",
                                ...
                                dbc.Col(
                                    dbc.Row(
                                        [
                                            ...
                                            dbc.Col(
                                                dmc.TextInput(
                                                    id="pag-editar-relatorio-input-wpp-1",
                                            ...
                                            dbc.Col(
                                                dmc.TextInput(
                                                    id="pag-editar-relatorio-input-wpp-2",
                                                    placeholder="(62) 99999-9999",
                                                    value="",
                                                    leftSection=DashIconify(icon="logos:whatsapp-icon"),
                                                ),
                                            ...
                                            dbc.Col(
                                                dmc.TextInput(
                                                    id="pag-editar-relatorio-input-wpp-3",
                                                    placeholder="(62) 99999-9999",
                                                    value="",
                                                    leftSection=DashIconify(icon="logos:whatsapp-icon"),
                                                ),
                                            ...
                                            dbc.Col(
                                                dmc.TextInput(
                                                    id="pag-editar-relatorio-input-wpp-4",
                                                    placeholder="(62) 99999-9999",
                                                    value="",
                                                    leftSection=DashIconify(icon="logos:whatsapp-icon"),
                                                ),
                                            ...
                                            dbc.Col(
                                                dmc.TextInput(
                                                    id="pag-editar-relatorio-input-wpp-5",
                                                    placeholder="(62) 99999-9999",
                                                    value="",
                                                    leftSection=DashIconify(icon="logos:whatsapp-icon"),
                                                ),
                                    ...
                                    id="pag-editar-relatorio-input-wpp-destino-container",
                                    md=12,
                                ),
                            ],
                            align="center",
        ...
        dmc.Space(h=30),
        # Botão Atualizar Regra
        dbc.Row(
            [
                dbc.Col(
                    dbc.Button(
                        "Atualizar Regra",
                        id="pag-editar-relatorio-btn-salvar-regra",
                        color="success",
                        className="me-1",
...
# Registro da página #########################################################
##############################################################################
dash.register_page(__name__, name="Editar Regra", path="/relatorio-editar", icon="carbon:rule-draft", hide_page=True)
